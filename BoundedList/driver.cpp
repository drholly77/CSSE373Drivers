...
#include "wrapper.h"
#include "BoundedList/BoundedList1.hpp"


#ifdef NDEBUG
// When NDEBUG is defined, that means: Compiling in Not Debug configuration = Release Configuration
typedef BoundedList1<Text, 5> TextList;
#else
// Compiling in Debug configuration
#include "BoundedList/BoundedListChecking.hpp"
typedef BoundedListChecking1<Text, 5, BoundedList1<Text, 5>> TextList;
#endif
...
int main (int argc, char* argv[])
{
	...
	do {
		...
		case 'n':
			...
			wcout << "s" << i << " remaining capacity = " << z << endl;
			break;
		case 'x':
			wcout << "Transfer from ";
			i = getIndex();
