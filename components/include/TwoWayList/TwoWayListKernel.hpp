...
template <class TwoWayListOfT, class T>
class TwoWayListKernel
		//! TwoWayListOfT - type TwoWayListX<T>, where X is an implementation number
		//! T - type of TwoWayListKernel entries
		//!  
		...
		//! type TwoWayListKernel is modeled by LIST_MODEL
		//! exemplar self
		//! initially 
		//!    ensures: self = (<>,<>)
{
public: // List Specific Operations
	...
	virtual void swapRights(TwoWayListOfT& otherS) = 0;
