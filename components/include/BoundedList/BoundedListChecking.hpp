...
template <class T, int maxLength, class UncheckedBoundedList>
class BoundedListChecking1 : public UncheckedBoundedList
{
private:
	typedef UncheckedBoundedList BoundedListOfT;
public:
...
void swapRights(BoundedListOfT& otherS)
{
