...
/*
	First-in-first-out (FIFO) preemptable queue kernel component with primary methods
*/
...
template <class T>
class PreemptableQueueKernel
		//! T - type of PreemptableQueueKernel entries
		//! 
		//! Mathematical Model (abstract value and abstract invariant of self):
		//! type PreemptableQueueKernel is modeled by string of T
		//! exemplar self
		//! initially 
		//!    ensures: self = <>
{
